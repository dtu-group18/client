 ...
 * 
 */
@WebServiceClient(name = "BankServiceService", targetNamespace = "http://fastmoney.ws.dtu/", wsdlLocation = "http://fm-00.compute.dtu.dk:80/BankService.wsdl.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://fm-00.compute.dtu.dk:80/BankService.wsdl.xml");
